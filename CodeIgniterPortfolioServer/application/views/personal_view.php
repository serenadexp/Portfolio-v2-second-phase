...
<html>
	...
	<div id="contact" class="contactHide">
		...
		<div id="wrapper">
			...
			</div><!--closed personalDetails -->
			
			<div id="currentSkills">
				<p class="currentSkillsFnt currentSki">Current Skills</p>
...
Code Igniter framework and OOP.</p>
					...
					<div class="skillContainerLine"></div><!--closed skillContainerLine -->
				</div><!--closed skillColThree -->
				
				
			</div><!--closed currentSkills -->
			<div id="footer">
